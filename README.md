# TestTrack Website
A Covid-19 Testing Tracker Website created for Bay Area Hacks. 
By Aishwarya Ramesh and Aarushi Ramesh

## Won "Best Beginner Hack" in Bay Area Hacks 2020: 
**⚠️ The Google Maps API used has since expired or changed, so some functionality may be broken ⚠️**  
