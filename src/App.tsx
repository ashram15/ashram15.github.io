...
import synopspyDemo from './assets/synopspy_demo.gif';
import systemMonitorImage from './assets/system_health_monitor.png';
import sortingVisualizerImage from './assets/demo.png';
import testTrackImage from './assets/TestTrack.png';
      ...
      <div className="relative w-full h-screen flex items-start justify-center overflow-hidden">
        ...
        <div className="relative w-full max-w-4xl h-screen">
          ...
          >
            ...
            <motion.div
              className="absolute top-32 w-[700px] h-screen bg-gradient-to-b from-orange-400/50 via-yellow-300/25 to-transparent"
              style={{
          ...
          >
            {/* Outer glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-16 bg-orange-300/20 rounded-full blur-3xl" />
            {/* Middle glow */}
